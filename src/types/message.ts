export enum Message {
  ...
  DELETE_EVENT = 'DELETE_EVENT',                   // UI → Main: remove an unmapped event from the persistent store
  ...
  NAVIGATE_TO_NODE = 'NAVIGATE_TO_NODE',           // UI → Main: scroll viewport to a Frame node id (used by Tree view headers)
}
